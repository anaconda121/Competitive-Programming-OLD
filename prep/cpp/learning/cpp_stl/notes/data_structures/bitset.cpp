...
int main(){
    ...
    cout << bset1 << endl; // 00000000000000000000000000000000 (length 32)
    cout << bset2 << endl; // 00000000000000000000000000010100 (binary for 20)
    ...
    // count function returns number of set bits (count of 1) in bitset
